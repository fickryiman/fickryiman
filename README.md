...
<h4><em>Full-stack software developer ready for adventures</em> &nbsp; <img src="https://media.giphy.com/media/XGma2iRIHTKkwqRkFl/giphy.gif" width="50"></h4>
...
const fickrybiliman = {
  ...
  funFacts    : [`In a few years I see myself working in a more client-facing role with the company`, 
                 ...
                 'My dreams is to live and works in Switzerland, Finland, Austria or Holland']
};
```
<br>
